...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="Файл[Документ/@КНД='1167004']" mode ="Title">
		Извещение о получении электронного документа (документов)
	</xsl:template>
	
	<xsl:template match="Файл[Документ/@КНД='1167004']">
		<xsl:apply-templates select="Документ[@КНД='1167004']"/>
	</xsl:template>

	<xsl:template match="Документ[@КНД='1167004']">
		<p align='right' style='text-align:right'>
			<span style='font-size:11.0pt'>
				Форма по КНД 1167004
			</span>
		</p>
		<p>место штампа</p>
